...
public class ServerProperties {
    ...
    public static void saveProperties() {
        ...
        for (Map.Entry i : props.entrySet()) {
            ...
            if (((String) i.getKey()).contains("Job")) {
                job.add(info);
            } else {
                setting.add(info);
            }
    ...
    public static char getWorldProperty(String s, char def) {
        String property = props.getProperty(s);
        if (property != null) {
    ...
    public static String getWorldProperty(String s, String def) {
        String property = props.getProperty(s);
        if (property != null) {
            return property;
        }
    ...
    public static boolean getWorldProperty(String s, boolean def) {
        return getWorldProperty(s, def ? "true" : "false").equalsIgnoreCase("true");
    }

    public static byte getWorldProperty(String s, byte def) {
        String property = props.getProperty(s);
        if (property != null) {
            return Byte.parseByte(property);
        }
    ...
    public static short getWorldProperty(String s, short def) {
        String property = props.getProperty(s);
        if (property != null) {
            return Short.parseShort(property);
        }
    ...
    public static int getWorldProperty(String s, int def) {
        String property = props.getProperty(s);
        if (property != null) {
            return Integer.parseInt(property);
        }
    ...
    public static double getWorldProperty(String s, double def) {
        String property = props.getProperty(s);
        if (property != null) {
    ...
    public static long getWorldProperty(String s, long def) {
        String property = props.getProperty(s);
        if (property != null) {
            return Long.parseLong(property);
        }
