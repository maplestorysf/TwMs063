...
public abstract class Timer {
    ...
    public static class autoEventTimer extends Timer {

        private static final autoEventTimer instance = new autoEventTimer();

        private autoEventTimer() {
            name = "autoEventTimer";
        }

        public static autoEventTimer getInstance() {
            return instance;
        }
    }
