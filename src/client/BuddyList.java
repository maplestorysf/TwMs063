...
public class BuddyList implements Serializable {
    ...
    public void loadFromTransfer(final Map<BuddyEntry, Boolean> data) {
        ...
        for (final Map.Entry<BuddyEntry, Boolean> qs : data.entrySet()) {
            ...
            if (!pair) {
                ...
                put(new BuddyEntry(buddyid.getName(), buddyid.getCharacterId(), buddyid.getGroup(), -1, -1, true));
            }
        }
    }
    ...
    public void loadFromDb(int characterId) throws SQLException {
        ...
        while (rs.next()) {
            ...
            if (rs.getInt("pending") == 1) {
                pendingReqs.push(new BuddyEntry(buddyname, buddyid, rs.getString("groupname"), -1, -1, false));
            } else {
                put(new BuddyEntry(rs.getLong("id"), buddyname, buddyid, rs.getString("groupname"), -1, -1, true));
            }
        }
        rs.close();
        ps.close();
     ...
     */
    public void addBuddyRequest(MapleClient client, int buddyId, String buddyName, int buddyWorld, int buddyChannel) {

        this.put(new BuddyEntry(buddyName, buddyId, BuddyList.DEFAULT_GROUP, buddyWorld, buddyChannel, false));
        ...
        if (pendingReqs.isEmpty()) {
            ...
            BuddyEntry newPair = new BuddyEntry(buddyName, buddyId, BuddyList.DEFAULT_GROUP, -1, -1, false);
