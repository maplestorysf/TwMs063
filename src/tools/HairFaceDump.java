...
public class HairFaceDump {
    ...
    public static void main(String[] args) throws IOException {
        ...
        data = MapleDataProviderFactory.getDataProvider(new File(System.getProperty("server.wzpath", "wz") + "/Character.wz/Hair"));
        ...
        data = MapleDataProviderFactory.getDataProvider(new File(System.getProperty("server.wzpath") + "/Character.wz/Face"));
        root = data.getRoot();

        for (MapleDataFileEntry topDir
                : root.getFiles()) {
        ...
        if (maleHair1.isEmpty()
                || maleHair2.isEmpty() || maleHair3.isEmpty() || femaleHair1.isEmpty() || femaleHair2.isEmpty() || femaleHair3.isEmpty() || maleFace.isEmpty() || femaleFace.isEmpty()) {
    ...
    public static boolean hairExists(int hair) {
        MapleDataProvider data = MapleDataProviderFactory.getDataProvider(new File(System.getProperty("server.wzpath") + "/Character.wz/Hair"));
    ...
    public static boolean faceExists(int face) {
        MapleDataProvider data = MapleDataProviderFactory.getDataProvider(new File(System.getProperty("server.wzpath") + "/Character.wz/Face"));
        final MapleDataDirectoryEntry root = data.getRoot();
        for (MapleDataFileEntry topDir : root.getFiles()) {
            int id = Integer.parseInt(topDir.getName().substring(0, 8));
            if (id == face) {
