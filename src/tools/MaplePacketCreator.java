...
//        mplew.writeInt(summon.getObjectId());
    ...
    public static byte[] getHeartSmega(String message, boolean ear, int channel) {
        return broadcastMessage(8, channel, new String[]{message}, ear, null);
    }

    public static byte[] getSkullSmega(String message, boolean ear, int channel) {
        return broadcastMessage(9, channel, new String[]{message}, ear, null);
    }
...
//        mplew.writeLong(firstmask);
    ...
    public static byte[] giveMount(int buffid, int skillid, List<Pair<MapleBuffStat, Integer>> statups) {
        ...
        mplew.writeShort(1);
        mplew.writeInt(skillid); // 1902000 saddle
        mplew.writeInt(2100000000); // skillid
        mplew.writeShort(0);
        mplew.write(0);
...
//        mplew.writeShort(c.getPlayer().getJob());
    ...
    public static byte[] getStorageError(int type) {
        MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
