...
public class ServerConstants {
    ...
    // End of Poll
    public static final short MAPLE_VERSION = 63;
    ...
    public static boolean MobDropMPoint = false;
    public static int MobDropMPointRate = 20;
    public static int MobDropMPointMin = 1;
    public static int MopDropMPointMax = 5;
    ...
    public static void loadSetting() {
        ...
        String[] xxx = ServerProperties.getProperty("MapNotCC", "910360000, 910360001, 910360100, 910360101").split(",");
