...
public class PlayerStorage {
    ...
    public final void registerPlayer(final MapleCharacter chr) {
        ...
        World.Find.register(chr.getId(), chr.getName(), channel, chr.getWorld());
    }
...
//            }
    ...
    public final CharacterTransfer getPendingCharacter(final int charid) {
        return getPendingCharacter(charid, true);
    }

    public final CharacterTransfer getPendingCharacter(final int charid, final boolean remove) {
    ...
    public final void broadcastEtcSmegaPacket(final byte[] data) {
        ...
        try {
            ...
            while (itr.hasNext()) {
                ...
                if (chr.getClient().isLoggedIn() && chr.getTSmega()) {
                    chr.getClient().sendPacket(data);
                }
            }
        } finally {
