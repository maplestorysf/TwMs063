...
public class CharacterTransfer implements Externalizable {
    ...
    public String name, accountname, BlessOfFairy, chalkboard, charmessage, prefix, nowmacs, tempIP;
    ...
    public boolean check_msg_BuyMerChant, check_msg_Chat, check_msg_MobVac, Vip_Medal, DebugMessage, canTalk, smega, tsmega, showLogin, showRegister, attackdebug;
    public transient EventInstanceManager eventInstance;

    public CharacterTransfer() {
    }

    public CharacterTransfer(final MapleCharacter chr) {
        this.eventInstance = chr.getEventInstance();
    ...
    public void readExternal(final ObjectInput in) throws IOException, ClassNotFoundException {
        ...
        for (int i = 0; i < addedbuddysize; i++) {
            buddies.put(new BuddyEntry(in.readUTF(), in.readInt(), in.readUTF(), in.readInt(), in.readInt(), in.readBoolean()), in.readBoolean());
        }
